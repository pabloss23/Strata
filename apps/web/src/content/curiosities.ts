...
// influyentes, cada uno con su FUENTE, su AÑO y un ENLACE a la fuente original
// (epistemia honesta, ver CLAUDE.md). No son datos de métrica del pipeline: son
// contenido editorial curado, por eso viven aquí (content/) y no en data/. Al pulsar
// una tarjeta se selecciona el país en el globo; el enlace abre la fuente. Optimista
// pero verificable: cada tarjeta dice de dónde sale y deja comprobarlo.
...
export interface Curiosity {
  ...
  source: string; // fuente (organismo o publicación)
  url: string; // enlace a la fuente original (dominio oficial y estable)
...
// con su fuente y enlace; el año refleja el dato más reciente disponible.
export const CURIOSITIES: Curiosity[] = [
  ...
  },
  {
    ...
    year: 2025,
    source: "IEA",
    url: "https://www.iea.org/countries/costa-rica",
  ...
  },
  {
    ...
    year: 2025,
    source: "IEA",
    url: "https://www.iea.org/countries/kenya",
  ...
  },
  {
    ...
    year: 2025,
    source: "WHO",
    url: "https://www.who.int/countries/jpn",
